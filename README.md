...
> 零克隆、零配置、AI 按需读取 SKILL — [查看各工具详细配置](https://omnisockit.com/docs/guides/mcp-setup)
...
| AI 工具 | MCP 支持 | 手动注入 |
|---------|:--------:|----------|
| **Claude Desktop** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#claude-desktop) | — |
| **Claude Code** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#claude-code) | `.claude/skills/` |
| **Cursor** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#cursor) | `.cursorrules` |
| **Windsurf** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#windsurf) | `.windsurfrules` |
| **VS Code + Copilot** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#vscode-copilot) | 上下文参考 |
| **Trae** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#trae) | — |
| **Cline** | ✅ [配置](https://omnisockit.com/docs/guides/mcp-setup#cline) | 知识库 |
| **其他 MCP 工具** | ✅ [通用配置](https://omnisockit.com/docs/guides/mcp-setup) | System Prompt |
...
[官网](https://omnisockit.com) · [MCP Server](https://www.npmjs.com/package/@omnisockit/mcp-server) · [Issues](https://github.com/OmniSocKit/Open-Wecom-Skills/issues) · [Discussions](https://github.com/OmniSocKit/Open-Wecom-Skills/discussions)
